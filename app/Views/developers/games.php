...
<title>Hry</title>
<h1 class="fw-bold mb-4">Hry vyvinuté společností <?= $vyvojari['name'] ?></h1>
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="card bg-dark text-light border-secondary h-100">
            ...
            <?php foreach($achievementy as $achievement):
                ...
                {
                    ?>
                        <button class="fw-bold mb-2 btn btn-sm" data-bs-toggle="modal" data-bs-target="#achievement<?= $achievement['id_achievement'] ?>">
                            <?= $achievement['name']; ?>
                        </button>
